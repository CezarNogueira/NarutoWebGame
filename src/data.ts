...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    reward: 3200, xpReward: 200,
    enemy: { name: "Líder Saqueador", emoji: "👺", maxHp: 220, attack: 32, defense: 12, speed: 16,
      moves: [{"name":"Esmagamento","power":35,"element":"Físico"}] },
  },
  {
    id: "m21", name: "Escolta VIP", rank: "B", recommendedLevel: 11,
    description: "Proteja um nobre durante sua viagem.",
    reward: 6000, xpReward: 350,
    enemy: { name: "Assassino Contratado", emoji: "🗡️", maxHp: 260, attack: 40, defense: 15, speed: 25,
      moves: [{"name":"Corte Letal","power":45,"element":"Físico"}] },
  },
  {
    id: "m22", name: "Interceptar Suprimentos", rank: "B", recommendedLevel: 12,
    description: "Roube suprimentos de uma aldeia rival.",
    reward: 7000, xpReward: 380,
    enemy: { name: "Guarda de Elite", emoji: "🛡️", maxHp: 300, attack: 38, defense: 20, speed: 18,
      moves: [{"name":"Investida com Escudo","power":40,"element":"Físico"}] },
  },
  {
    id: "m23", name: "Rastrear Fugitivo", rank: "B", recommendedLevel: 13,
    description: "Encontre um criminoso procurado no Bingo Book.",
    reward: 8500, xpReward: 450,
    enemy: { name: "Criminoso Rank B", emoji: "👤", maxHp: 320, attack: 45, defense: 18, speed: 24,
      moves: [{"name":"Liberação de Água","power":48,"element":"Água"}] },
  },
  {
    id: "m24", name: "Patrulha de Fronteira", rank: "B", recommendedLevel: 15,
    description: "Defenda a fronteira contra uma pequena invasão.",
    reward: 10000, xpReward: 500,
    enemy: { name: "Ninja Invasor", emoji: "🥷", maxHp: 380, attack: 50, defense: 22, speed: 26,
  ...
  },
  {
    ...
    reward: 12000, xpReward: 600,
    enemy: { name: "Especialista em Armadilhas", emoji: "🕸️", maxHp: 350, attack: 48, defense: 18, speed: 30,
  ...
  },
  {
    ...
    reward: 15000, xpReward: 750,
    enemy: { name: "Nukenin das Águas", emoji: "🌧️", maxHp: 450, attack: 58, defense: 25, speed: 28,
  ...
  },
  {
    ...
    reward: 22000, xpReward: 1100,
    enemy: { name: "Comandante Rebelde", emoji: "👹", maxHp: 600, attack: 75, defense: 30, speed: 35,
  ...
  },
  {
    ...
    reward: 25000, xpReward: 1250,
    enemy: { name: "Ninja Invocador", emoji: "📜", maxHp: 650, attack: 70, defense: 28, speed: 40,
  ...
  },
  {
    ...
    reward: 30000, xpReward: 1500,
    enemy: { name: "Vanguarda Inimiga", emoji: "⚔️", maxHp: 800, attack: 85, defense: 35, speed: 30,
  ...
  },
  {
    ...
    reward: 35000, xpReward: 1800,
    enemy: { name: "Guardião Antigo", emoji: "🗿", maxHp: 1000, attack: 90, defense: 45, speed: 25,
  ...
  },
  {
    ...
    reward: 45000, xpReward: 2200,
    enemy: { name: "Nukenin Perigoso", emoji: "😈", maxHp: 1200, attack: 105, defense: 40, speed: 50,
  ...
  },
  {
    ...
    reward: 55000, xpReward: 2800,
    enemy: { name: "Cientista Sombrio", emoji: "🧪", maxHp: 1500, attack: 110, defense: 38, speed: 45,
  ...
  },
  {
    ...
    reward: 70000, xpReward: 3500,
    enemy: { name: "Clone de Kage", emoji: "👑", maxHp: 2000, attack: 130, defense: 50, speed: 60,
