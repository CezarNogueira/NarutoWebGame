...
if (!content.includes("autoLearnNatureJutsus")) {
  content = content.replace("const levelUpIfNeeded = (n: Ninja) => {", autoLearn + "\n  const levelUpIfNeeded = (n: Ninja) => {");
  content = content.replace("n.maxChakra += 10;", "n.maxChakra += 10;\n      autoLearnNatureJutsus(n);");
